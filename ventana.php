...
<div style="z-index: 15; width: 20%; position: fixed; border: solid #000 0px; height: 30px; bottom: 0px; right: 0px; display: inline-block; " >
	
	<div class="a" id="vusuu">

		<div class="b" id="tusu">
		<a href="#" onclick="desplegar1('usuu');" ><font color="#fff">Usuarios</font></a>
		</div>
...
*/
		...
		var idd="'usu"+id+"'";
		$('#tusu'+id).html('<a href="#"  onclick="desplegar('+idd+')"> <font color="#fff">'+este.innerHTML+'</font></a>');
