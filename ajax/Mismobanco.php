...
$sql="SELECT che.tipopago,che.cuentasalida,pro.cuenta,pro.clavebanco,che.monto,che.FolioSantander,che.fecha,pro.email 
from cheques as che 
left join proveedores as pro on pro.id = che.beneficiario 
where che.fechaautorizado='$fechaautorizado' and pro.tipocuenta='SANTAN' and che.tipopago!='1' order by fechaautorizado desc";
