    ...
    if($action == 'ajax'){
        // escaping, additionally removing everything that could be (html/javascript-) code
         ...
         if($_SESSION['user_tipo']!="0")
            {
                $and=" where  programa='".$_SESSION['programa']."'   ";
            }
        ...
        if ( $_GET['q'] != "" )
        {
            if($_SESSION['user_tipo']!="0")
            {
                $and="  programa='".$_SESSION['programa']."' and  ";
            }
        ...
        $sWhere.=" $and order by created_at desc";
            ...
            <table class="table table-striped jambo_table bulk_action">
                <thead>
                    <tr class="headings">
                        ...
                        <th class="column-title">Contrase&ntilde;a </th>
                ...
                ?>
                    ...
                    <tr class="even pointer">
                        ...
                        <td><input class="form-control" type="text"  value="<?php echo str_replace(" ", "", $rutas);?>" onkeyup="cambia_ruta(<?php echo $id;?>,this);" placeholder="Ej. R1,R2"></td>
