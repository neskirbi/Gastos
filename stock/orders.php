...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<?php if($_GET['o'] == 'add') { ?>
  		<i class="glyphicon glyphicon-plus-sign"></i>	Agregar Envio
		<?php } else if($_GET['o'] == 'manord') { ?>
			<i class="glyphicon glyphicon-edit"></i> Administrador de Envios
		<?php } else if($_GET['o'] == 'editOrd') { ?>
			<i class="glyphicon glyphicon-edit"></i> Editar Envio
		<?php } ?>
	...
	<div class="panel-body">
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    <label for="orderDate" class="col-sm-2 control-label">Fecha de Envio</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="orderDate" name="orderDate" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="clientName" class="col-sm-2 control-label">Destinatario</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientName" name="clientName" placeholder="Destinatario" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="clientContact" class="col-sm-2 control-label">Direccion de Envio</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientContact" name="clientContact" placeholder="Domicilio" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->			  
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group" style="display: none">
				    ...
				    <div class="col-sm-9">
				      <select class="form-control" name="paymentType" id="paymentType" value='1'>
				  ...
				  <div class="form-group" style="display: none">
				    ...
				    <div class="col-sm-9">
				      <select class="form-control" name="paymentStatus" id="paymentStatus" value='1'>
				  ...
				  <div class="form-group">
				    <label for="subTotal" class="col-sm-3 control-label" >Costo de Arti.</label>
				    <div class="col-sm-9">
			  ...
			  <div class="form-group submitButtonFooter">
			    ...
			    <button type="button" class="btn btn-default" onclick="addRow()" id="addRowBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-plus-sign"></i> Agregar Articulo </button>
			      ...
			      <button type="reset" class="btn btn-default" onclick="resetOrderForm()"><i class="glyphicon glyphicon-erase"></i> Borrar</button>
			    </div>
			  </div>
			</form>
		<?php } else if($_GET['o'] == 'manord') { 
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
			  ...
			  <div class="form-group">
			    <label for="orderDate" class="col-sm-2 control-label">Fecha Envio</label>
			    <div class="col-sm-10">
			  ...
			  <div class="form-group">
			    <label for="clientContact" class="col-sm-2 control-label">Direccion</label>
			    <div class="col-sm-10">
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group" style="display: none">
				    <label for="vat" class="col-sm-3 control-label">VAT 16%</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group" style="display: none">
				    <label for="discount" class="col-sm-3 control-label">Disponible</label>
				    <div class="col-sm-9">
			  ...
			  <div class="col-md-6">
			  	<div class="form-group" style="display: none">
				    <label for="paid" class="col-sm-3 control-label">Monto enviado</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="paid" name="paid" autocomplete="off" onkeyup="paidAmount()" value="<?php echo $data[9] ?>"  />
				    </div>
				  </div> <!--/form-group-->			  
				  <div class="form-group" style="display: none">
				    <label for="due" class="col-sm-3 control-label">Monto Enviado</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group" style="display: none">
				    <label for="clientContact" class="col-sm-3 control-label">Tipo Envio</label>
				    <div class="col-sm-9">
				...
				<div class="form-group">
				    <label for="subTotal" class="col-sm-3 control-label">Costo Articulos</label>
				    <div class="col-sm-9">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="glyphicon glyphicon-edit"></i> Editar Envio</h4>
      </div>      
      ...
      <div class="modal-body form-horizontal" style="max-height:500px; overflow:auto;" >
      	...
      	<div class="paymentOrderMessages"></div>
			  ...
			  <div class="form-group">
			    <label for="due" class="col-sm-3 control-label">Cantidad Enviada</label>
			    <div class="col-sm-9">
			      <input type="text" class="form-control" id="due" name="due" disabled="true" />					
			    </div>
			  </div> <!--/form-group-->		
			  <div class="form-group">
			    <label for="payAmount" class="col-sm-3 control-label">Envio Pagado</label>
			    <div class="col-sm-9">
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeOrderModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><i class="glyphicon glyphicon-trash"></i> Eliminar Envio</h4>
      </div>
      <div class="modal-body">

      	<div class="removeOrderMessages"></div>

        <p>Seguro de eliminar el Envio ?</p>
      </div>
