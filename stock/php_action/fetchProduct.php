...
if($result->num_rows > 0) { 
 ...
 while($row = $result->fetch_array()) {
 	...
 	// active 
 	if($row[5] >= 1) {
 		// activate member       mostrar productos.
	...
	<div class="btn-group">
	  ...
	  <ul class="dropdown-menu">
	    ...
	    <li><a type="button" data-toggle="modal" data-target="#removeProductModal" id="removeProductModalBtn" onclick="removeProduct('.$productId.')"> <i class="glyphicon glyphicon-trash"></i> Borrar</a></li>       
	  </ul>
	</div>';
